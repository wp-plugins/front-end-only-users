		...
		<div id="side-sortables" class="metabox-holder ">
			<div id="feup-upgrade" class="postbox " >
				...
				<div class="inside">
					...
					<?php } else { ?><ul><li><?php _e("Thanks for upgrading to version 2.2.3!", "EWD_FEUP"); ?><br> <a href='http://www.facebook.com/EtoileWebDesign'><?php _e("Follow us on Facebook", "EWD_FEUP"); ?></a> <?php _e("to suggest new features or hear about upcoming ones!", "EWD_FEUP");?> </li></ul><?php }  ?>
