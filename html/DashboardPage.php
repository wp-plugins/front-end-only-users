...
<div id="upcp_pro" class="postbox " >
		...
		<div class="inside">
				<ul>
						<li><?php _e("Thanks for being an early adopter! Anyone who installs before June 30th will always have access to new features, updates and full product support.", 'EWD_FEUP'); ?></li>
