...
<div id="upcp_pro" class="postbox " >
		...
		<div class="inside">
				<ul>
						<li><?php _e("Thanks for being an early adopter! Anyone who installs before March 31st will always have access to new features, updates and full product support.", 'EWD_FEUP'); ?></li>
...
<form action="admin.php?page=EWD-FEUP-options&Action=MassDeleteUserFields" method="post">    
				...
				<tr>
						<th scope='col' id='cb' class='manage-column column-cb check-column'  style="">
								<input type="checkbox" /></th><th scope='col' id='field-name' class='manage-column column-name sortable desc'  style="">
										<?php if ($_GET['OrderBy'] == "Field_Name" and $_GET['Order'] == "ASC") { echo "<a href='admin.php?page=EWD-FEUP-options&DisplayPage=User_Fields&OrderBy=Field_Name&Order=DESC'>";}
						...
						<th scope='col' id='type' class='manage-column column-type sortable desc'  style="">
									  <?php if ($_GET['OrderBy'] == "Field_Type" and $_GET['Order'] == "ASC") { echo "<a href='admin.php?page=EWD-FEUP-options&DisplayPage=User_Fields&OrderBy=Field_Type&Order=DESC'>";}
						...
						<th scope='col' id='description' class='manage-column column-description sortable desc'  style="">
									  <?php if ($_GET['OrderBy'] == "Field_Description" and $_GET['Order'] == "ASC") { echo "<a href='admin.php?page=EWD-FEUP-options&DisplayPage=User_Fields&OrderBy=Field_Description&Order=DESC'>";}
						...
						<th scope='col' id='required' class='manage-column column-users sortable desc'  style="">
									  <?php if ($_GET['OrderBy'] == "Field_Required" and $_GET['Order'] == "ASC") { echo "<a href='admin.php?page=EWD-FEUP-options&DisplayPage=User_Fields&OrderBy=Field_Required&Order=DESC'>";}
		 ...
		 <?php
				if ($myrows) { 
	  			  foreach ($myrows as $Field) {
								...
								echo "<a class='delete-tag' href='admin.php?page=EWD-FEUP-options&Action=DeleteField&DisplayPage=User_Fields&Field_ID=" . $Field->Field_ID ."'>" . __("Delete", 'EWD_FEUP') . "</a>";
		 						echo "</span>";
								echo "</div>";
